...
async def mes_me (client,message):
    if message.text[0:18] == 'Добавь прокладку @':
        ...
        try:
            ...
            <a href = https://t.me/kwest_movie_bot?start={user_channel}>🍿НАЧАТЬ СМОТРЕТЬ🍿</a>""")
...
async def payments (client,message):
    if message.text[0:2] =='Пп' and message.from_user.id == my_id:
